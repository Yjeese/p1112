...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			...
			$itemArray = array($productByCode[0]["code"]=>array('name636'=>$productByCode[0]["name636"], 'code'=>$productByCode[0]["code"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode[0]["price"], 'image'=>$productByCode[0]["image"]));
  ...
  <body>
    ...
    <div class="right-box">
      <div class="container">
        ...
        <p class>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores, consequuntur?</p>
      </div>
    <div class="wrapper">
...
<div class="wrapper">
<a href="logout.php" class="open-button pull-right"><i class="fa fa-plus"></i> Sign Out</a>
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				<tr>
				<td><img src="<?php echo $item["image"]; ?>" class="cart-item-image" /><?php echo $item["name636"]; ?></td>
...
<div id="product-grid">
	...
	?>
		...
		<div class="image">
			...
			<div class="product-title"><?php echo $product_array[$key]["name636"]; ?></div>
